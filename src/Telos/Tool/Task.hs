...
taskTool :: Tool
taskTool = makeTool "task" inputSchema
         & toolDescription ?~ description
  where
    description :: Text
    description = "Delegate a subtask to a new agent. The agent runs with \
      ...
      , "properties" .= object
          [ "prompt" .= object
              ...
              , "description" .= ("The task description for the subagent. \
                                  \Be specific about what you want done." :: Text)
              ]
          ...
          , "description" .= object
              [ "type" .= ("string" :: Text)
              , "description" .= ("Brief description of the task for \
